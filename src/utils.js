...
export const COUNTRY_DATA = {
	...
	'MO': { name: 'Macao', emoji: '🇲🇴', aliases: ['澳门', '澳門', 'Macao', 'Macau', 'MO'] },
	...
	'RU': { name: 'Russia', emoji: '🇷🇺', aliases: ['俄罗斯', 'Russia', 'RU'] },
	'CA': { name: 'Canada', emoji: '🇨🇦', aliases: ['加拿大', 'Canada', 'CA'] },
	'AU': { name: 'Australia', emoji: '🇦🇺', aliases: ['澳大利亚', 'Australia', 'AU'] },
	...
	'NL': { name: 'Netherlands', emoji: '🇳🇱', aliases: ['荷兰', 'Netherlands', 'NL'] },
	...
	'MY': { name: 'Malaysia', emoji: '🇲🇾', aliases: ['马来西亚', 'Malaysia', 'MY'] },
	...
	'ID': { name: 'Indonesia', emoji: '🇮🇩', aliases: ['印度尼西亚', 'Indonesia', 'ID'] },
	'NZ': { name: 'New Zealand', emoji: '🇳🇿', aliases: ['新西兰', 'New Zealand', 'NZ'] },
	'AE': { name: 'United Arab Emirates', emoji: '🇦🇪', aliases: ['阿联酋', 'United Arab Emirates', 'AE'] },
};
